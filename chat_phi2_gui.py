...
class ChatApp:
    def __init__(self, master):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("cognitivecomputations/dolphin-2_6-phi-2", trust_remote_code=True)

        self.streamer = TextStreamer(skip_prompt=True, tokenizer=self.tokenizer)

        self.system_instruction = {
            "role": "system",
            "content": "You are Dolphin, a helpful AI assistant. Keep your response polite and concise.",
        }
